...
public class Oferta {
    ...
    public Oferta(Integer cod_oferta, String tempo_inicial, String tempo_final, Integer percentual_desconto, Pacote cod_pacote) {
    ...
    public String getTempo_inicial() {
        return tempo_inicial;
    }

    public void setTempo_inicial(String tempo_inicial) {
        this.tempo_inicial = tempo_inicial;
    }

    public String getTempo_final() {
        return tempo_final;
    }

    public void setTempo_final(String tempo_final) {
        this.tempo_final = tempo_final;
    }
